...
const Footer = () => {
  return (
    <footer>
      <div className="bg-background mt-12 max-w-7xl mx-auto">
        <div className="border-t border-t-gray-100 mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center text-center">
